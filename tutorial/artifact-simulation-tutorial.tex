...
なお本稿は，社会科学分野の学生・研究者を主な読者に想定し，Web 技術やプログラミングの予備知識を前提としない．情報技術の専門用語には初出時に解説を付し（短い言い換えは本文の括弧内に，長い説明は脚注に置く），略語（アクロニム）には初出時に正式名称を併記する．
